...
$_SESSION['id'] = $idPlayer ;


$query = "SELECT * FROM players
    JOIN nationality ON nationality.id = players.id_natio
    JOIN clubs ON clubs.id = players.id_club
    LEFT JOIN other_players ON other_players.id_player = players.id 
    LEFT JOIN goalkeeper ON goalkeeper.id_player = players.id
    WHERE players.id = $idPlayer;";
    $data = mysqli_query($conn, $query);
    $rowPlayer = mysqli_fetch_assoc($data);
?>
    ...
    <div class="app-container">
            ...
            <ul class="sidebar-list">
                ...
                <li class="sidebar-list-item active">
                    <a href="#" class="redirect" id="playersLink">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            class="feather feather-shopping-bag" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="sidebar-list-item">
                    <a href="#" class="redirect" id="teamsLink">
                        <svg viewBox="0 0 24 24" version="1.1" class="feather feather-inbox" width="18" height="18">
                            <g stroke-width="0"></g>
                            <g stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="ic_fluent_team_add_24_filled" fill="white" fill-rule="nonzero">
                                        <path
        ...
        <div class="app-content">
            ...
            <div class="products-area-wrapper tableView">
                ...
                <div class="statisticsLink" style="display: none ;">statisticsLink</div>
                <div class="teamsLink" style="display: none ;">teamsLink</div>
                <div class='addPlayerContainer formLink' style="display: block ;">
                    <div class="formContainer">
                        <div>
                            <h3 style="color: white; font-family: Arial, Helvetica, sans-serif; padding: 3px ;">Modify
                                player
                            </h3>
                        </div>
                            ...
                            <form action="process.php" id="formData" method="POST" enctype="multipart/form-data">
                                <div class="textInputs">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" value="<?php echo $rowPlayer['name_player']; ?>" placeholder="Player name">
                                    </div>
                                    <div>
                                        <label for="">Nationality</label>
                                        <select name="nationality" id="nationality">
                                            <option value="<?php echo $idPlayer ?>" selected><?php echo htmlspecialchars($rowPlayer['nom_natio']); ?></option>
                                            <?php
                                            include('../src/config/database.php');
                                    ...
                                    <div>
                                        ...
                                        <select name="club" id="club">
                                            <option value="<?php echo $idPlayer ?>" selected><?php echo $rowPlayer['name_club']; ?></option>
                                            <?php
                                            include('../src/config/database.php');
                                    ...
                                    <div class="positionSelect">
                                        ...
                                        <select name="positionSelect" id="positionSelect">
                                            <option value="<?php echo $rowPlayer['position']; ?>" selected><?php echo $rowPlayer['position']; ?></option>
                                ...
                                <div class="filesInput">
                                    <div class="fileContainer">
                                        ...
                                        <input type="file" id="photo" name="photo"  value="<?php echo $rowPlayer['photo']; ?>">
                                        <div class="photoOutput">
                                            <img src="<?php echo $rowPlayer['photo']; ?>" alt="" id="photoOutput">
                                        </div>
                                    </div>
                                </div>
                                <div class="numInputs" id="numInputs">
                                    <div class="div">
                                        <label for="">RAT</label>
                                        <input class="num" type="number" name="ratingPL" id="rating2"
                                            placeholder="10 -> 99" value="<?php echo $rowPlayer['rating']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">PAC</label>
                                        <input class="num" type="number" name="pace" placeholder="10 -> 99" value="<?php echo $rowPlayer['pace']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">SHO</label>
                                        <input class="num" type="number" name="shooting" placeholder="10 -> 99" value="<?php echo $rowPlayer['shooting']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">PAS</label>
                                        <input class="num" type="number" name="passing" placeholder="10 -> 99" value="<?php echo $rowPlayer['passing']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">DRI</label>
                                        <input class="num" type="number" name="dribbling" placeholder="10 -> 99" value="<?php echo $rowPlayer['dribbling']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">DEF</label>
                                        <input class="num" type="number" name="defending" placeholder="10 -> 99" value="<?php echo $rowPlayer['defending']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">PHY</label>
                                        <input class="num" type="number" name="physical" placeholder="10 -> 99" value="<?php echo $rowPlayer['physical']; ?>" >
                                    </div>
                                ...
                                <div class="numInputs GKinputs" id="numInputsGK" style="display: none;">
                                    <div class="div">
                                        <label for="">RAT</label>
                                        <input class="numPlayer" type="number" name="ratingGK" id="rating1"
                                            placeholder="10 -> 99" value="<?php echo $rowPlayer['rating']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">DIV</label>
                                        <input class="numPlayer" type="number" name="diving" placeholder="10 -> 99" value="<?php echo $rowPlayer['diving']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">HAN</label>
                                        <input class="numPlayer" type="number" name="handling" placeholder="10 -> 99" value="<?php echo $rowPlayer['handling']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">KIC</label>
                                        <input class="numPlayer" type="number" name="kicking" placeholder="10 -> 99" value="<?php echo $rowPlayer['kicking']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">REF</label>
                                        <input class="numPlayer" type="number" name="reflexes" placeholder="10 -> 99" value="<?php echo $rowPlayer['reflexes']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">SPD</label>
                                        <input class="numPlayer" type="number" name="speed" placeholder="10 -> 99" value="<?php echo $rowPlayer['speed']; ?>" >
                                    </div>
                                    <div class="div">
                                        <label for="">POS</label>
                                        <input class="numPlayer" type="number" name="positioning"
                                            placeholder="10 -> 99" value="<?php echo $rowPlayer['positioning']; ?>" >
                                    </div>
                                    <button type="submit" class="createBtn">Submit</button>
                                </div>
                            </form>
